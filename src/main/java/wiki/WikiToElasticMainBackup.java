...
public class WikiToElasticMainBackup {

    private final static Logger LOGGER = LogManager.getLogger(WikiToElasticMainBackup.class);
    ...
    public static void main(String[] args) {
        try {
            ...
            InputStream inputStream = Objects.requireNonNull(WikiToElasticMainBackup.class.getClassLoader().getResourceAsStream("lang/" + config.getLang() + ".json"));
